...
//        }
        ...
        private RenderInfo makeVerts(DrawContext dc, int density)
        {
            ...
            MemoryCache cache = WorldWind.getMemoryCache(RectangularTessellator.class.getName());
...
//    protected RectangularTessellator.CacheKey createCacheKey(DrawContext dc, IcosaTile tile)
//    {
...
//                + " g0 " + this.g0 + " g1 " + this.g1 + " g2 " + this.g2;
    ...
    private static ArrayList<IcosaTile> makeRightTrianglesLevel0(GlobeInfo globeInfo)
    {

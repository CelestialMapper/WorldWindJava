 ...
 * @author kjdickin
 */
// A lot of this information is taken from generating an OpenGL CubeSphere in C++: http://www.songho.ca/opengl/gl_sphere.html#example_cubesphere
public class CubeSphereTessellator extends WWObjectImpl implements Tessellator
{
    ...
    protected static class RenderInfo
    {
        ...
        {
            // This isn't needed because everything is done in buildVerts() function
